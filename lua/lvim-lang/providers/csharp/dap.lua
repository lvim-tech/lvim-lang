-- lvim-lang.providers.csharp.dap: C# / .NET debugging through lvim-dap, backed by netcoredbg.
...
-- config (documented).
--
---@module "lvim-lang.providers.csharp.dap"
...
local function netcoredbg_bin()
    ...
    local resolved = toolchain.resolve("csharp", "netcoredbg", root)
            ...
            cs = {
                {
                    ...
                    program = function()
                        local root = require("lvim-lang.providers.csharp.tasks").root()
